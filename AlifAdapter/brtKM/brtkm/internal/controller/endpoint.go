...
// Payment - создать платеж
func (e *endPointController) Payment(c *gin.Context) {
	token := c.GetHeader("X-Token")
	operID := c.GetHeader("X-Request-ID")
...
// Payment - создать платеж
func (e *endPointController) ReceiverInfo(c *gin.Context) {
	token := c.GetHeader("X-token")
